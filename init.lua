...
-- to avoid save error w/ diagrams
...
vim.keymap.set('n', '<leader>hh', ':LspClangdSwitchSourceHeader<CR>', { desc = 'Clang switch sources/header' })
...
vim.keymap.set('v', '<leader>ge', ':ChatGPTEditWithInstructions<CR>', { desc = 'ChatGPT Edit' })
...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      local selected_model = 'openai/gpt-4o-mini'
